...
namespace AppLogicDBCUD
{
    public class Connection
    {
        ...
        public Connection()
        {
            ...
            dbConnection.ConnectionString = @"Provider=SQLNCLI11; Data Source=DESKTOP-3M6BAF9; Initial Catalog=Restaurant2; Persist Security Info=False; User ID=sa; Password=123456;";
        }
